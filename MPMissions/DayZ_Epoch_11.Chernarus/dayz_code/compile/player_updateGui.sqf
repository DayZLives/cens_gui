private ["_array","_audible","_blood","_bloodLvl","_bloodText","_bloodTotal","_bloodVal","_color","_combatVal","_ctrlADicon","_ctrlADvalue","_ctrlbanditKills","_ctrlBleed","_ctrlBlood","_ctrlBloodAmount","_ctrlBloodOuter","_ctrlCombat","_ctrlEar","_ctrlEye","_ctrlFood","_ctrlFoodBorder","_ctrlFracture","_ctrlHAColor","_ctrlHAValue","_ctrlHumanityAmount","_ctrlhumanKills","_ctrlMuteBackground","_ctrlMuteIcon","_ctrlTemp","_ctrlTempBorder","_ctrlThirst","_ctrlThirstBorder","_ctrlzombieKills","_display","_distance","_flash","_food","_foodLvl","_foodVal","_friendlies","_humanity","_humanityTarget","_id","_rfriendlies","_rfriendlyTo","_rID","_size","_string","_targetControl","_temp","_tempImg","_tempLvl","_tempText","_tempVal","_thirst","_thirstLvl","_thirstVal","_uiNumber","_visual"];
disableSerialization;
// ===========================================================================
// INFO:
// - Combat icon changed so relevant _ctr... not included
// - Blood test not used
// - Local vars adjusted
// ===========================================================================
_flash = {
...
if (isNil "_display") exitWith { [_foodVal,_thirstVal] };
// ===========================================================================
...
// ===========================================================================
// HUMANITY AMOUNT + HUMANITY FORMATTING AND CONDITIONAL COLOR
// ===========================================================================
_ctrlHumanityAmount = _display displayCtrl 1421;
_ctrlHAValue = player getVariable['humanity', 0];
if(_ctrlHAValue > 999999) then {
  _ctrlHAValue = [_ctrlHAValue] call fnc_format_humanity;
  _ctrlHAValue = toArray _ctrlHAValue;
  _ctrlHAValue = _ctrlHAValue - [44];
  _ctrlHAValue = toString _ctrlHAValue;
};
_ctrlHAColor = [1,1,1,1]; // white (neutral)
if(_ctrlHAValue < -5000) then {
  _ctrlHAColor = [0.68,0,0,1]; // theme GUI red (bandit)
} else {
  if(_ctrlHAValue > 5000) then {
    _ctrlHAColor = [0.38,0.63,0.26,1]; // theme GUI green (hero)
  };
};
_ctrlHumanityAmount ctrlSetText str(_ctrlHAValue);
_ctrlHumanityAmount ctrlSetTextColor _ctrlHAColor;
// ===========================================================================
// KILLS AMOUNT
// ===========================================================================
...
_ctrlCombat ctrlSetTextColor [(Dayz_GUI_R + (0.3 * (1-_combatVal))),(Dayz_GUI_G * _combatVal),(Dayz_GUI_B * _combatVal), 0.7]; // green, but 100% opacity
// ===========================================================================
_blood = "";
_thirst = "";
_food = "";
...
switch true do {
  ...
  case ((r_player_bloodpersec > 5) and (r_player_bloodpersec < 25)): { _uiNumber = 1 };
  case ((r_player_bloodpersec >= 25) and (r_player_bloodpersec < 50)): { _uiNumber = 2 };
  case (r_player_bloodpersec >= 50): { _uiNumber = 3 };
  default { _uiNumber = 0 };
};
